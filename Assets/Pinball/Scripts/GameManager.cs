...
public class GameManager : MonoBehaviour {
	...
	public GameObject targetPointManager2;
	public GameObject BallSpawnPointManager;
	...
	private List<GameObject> BallsSpawned = new List<GameObject>();
    ...
    public void StartGame() {
    	...
    	GameObject BallSpawnPoint = BallSpawnPointManager.transform.GetChild(Random.Range(0, BallSpawnPointManager.transform.childCount)).gameObject;
	...
	public void CreateBall() {
		//GameObject ball = Instantiate(ballPrefab,new Vector3(Random.Range(ballPoint.transform.position.x,ballPoint2.transform.position.x),0f,0f), Quaternion.identity) as GameObject;
	 //   listBall.Add(ball);
	}
	
	public void CreateAnotherBall() {
		
		GameObject Newball = BallSpawnPointManager.transform.GetChild(Random.Range(0, BallSpawnPointManager.transform.childCount)).gameObject;
		while (currentTargetPoint == Newball)
		{
			Newball = BallSpawnPointManager.transform.GetChild(Random.Range(0, BallSpawnPointManager.transform.childCount)).gameObject;
		}
		//ballPrefab.transform.position = Newball.transform.position;
		//Newball.SetActive(true);
		//GameObject ball = Instantiate(ballPrefab, ballPoint.transform.position, Quaternion.identity) as GameObject;
		BallsSpawned.Add(Newball);
		currentTargetPoint = Newball;
		//		Vector2 goldPos = BallSpawnPointManager.transform.position;
		Vector3 goldPos = BallSpawnPointManager.transform.position;	
		//Vector2 goldPos = Camera.main.ScreenToWorldPoint(BallSpawnPointManager.transform.position);
		//	currentTarget = Instantiate(ballPrefab, goldPos, Quaternion.identity) as GameObject;
